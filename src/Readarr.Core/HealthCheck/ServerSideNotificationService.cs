...
namespace Readarr.Core.HealthCheck
{
    public class ServerSideNotificationService : HealthCheckBase
    {
        ...
        public ServerSideNotificationService(IHttpClient client, IReadarrCloudRequestBuilder cloudRequestBuilder, IConfigFileProvider configFileProvider, ILocalizationService localizationService, Logger logger)
