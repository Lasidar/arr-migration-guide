...
namespace NzbDrone.Core.Datastore.Migration
{
    ...
    public class mediainfo_to_ffmpeg : NzbDroneMigrationBase
    {
        ...
        {
            var existing = conn.Query<MediaInfoRaw>("SELECT \"Id\", \"MediaInfo\", \"SceneName\" FROM \"EditionFiles\"");
            ...
            var updateSql = "UPDATE \"EditionFiles\" SET \"MediaInfo\" = @MediaInfo WHERE \"Id\" = @Id";
