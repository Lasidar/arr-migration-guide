...
namespace NzbDrone.Core.Test.Datastore
{
    ...
    public class WhereBuilderPostgresFixture : CoreTest
    {
        ...
        public void where_column_contains_string()
        {
            ...
            _subject.ToString().Should().Be($"(\"Series\".\"CleanTitle\" ILIKE '%' || @Clause1_P1 || '%')");
        ...
        public void where_string_contains_column()
        {
            ...
            _subject.ToString().Should().Be($"(@Clause1_P1 ILIKE '%' || \"Series\".\"CleanTitle\" || '%')");
            _subject.Parameters.Get<string>("Clause1_P1").Should().Be(test);
        }
        ...
        public void where_in_list_2()
        {
            ...
            _subject.ToString().Should().Be($"((\"Series\".\"CleanTitle\" = @Clause1_P1) AND (\"Series\".\"Id\" = ANY (('{{1, 2, 3}}'))))");
        }
        ...
        public void where_in_string_list()
        {
            ...
            _subject.ToString().Should().Be($"(\"Series\".\"CleanTitle\" = ANY (@Clause1_P1))");
        }
