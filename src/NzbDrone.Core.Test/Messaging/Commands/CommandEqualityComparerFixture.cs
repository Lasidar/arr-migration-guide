...
namespace NzbDrone.Core.Test.Messaging.Commands
{
    ...
    public class CommandEqualityComparerFixture
    {
        ...
        {
            var command1 = new SeasonSearchCommand { AuthorId = 1, BookNumber = 1 };
            var command2 = new SeasonSearchCommand { AuthorId = 1, BookNumber = 1 };
        ...
        {
            var command1 = new SeasonSearchCommand { AuthorId = 1, BookNumber = 1 };
            var command2 = new SeasonSearchCommand { AuthorId = 1, BookNumber = 2 };
        ...
        {
            var command1 = new SeasonSearchCommand { AuthorId = 1, BookNumber = 1 };
            var command2 = new SeasonSearchCommand { AuthorId = 2, BookNumber = 2 };
