...
{
    public static class ReadarrLogger
    {
        ...
        private static void RegisterSentry(bool updateClient, IAppFolderInfo appFolderInfo)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogManager.GetLogger(nameof(ReadarrLogger)).Debug(ex, "Failed to load dependency, may need an OS update");
        ...
        public static void ConfigureConsoleLayout(ColoredConsoleTarget target, ConsoleLogFormat format)
        {
            ...
            {
                ConsoleLogFormat.Clef => ReadarrLogger.ClefLogLayout,
                _ => ReadarrLogger.CleansingConsoleLayout
            };
        }
    }
